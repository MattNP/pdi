...
msgbox({'Software para reconocer esquejes' 'Desarrollado por:' '>>Mateo Noreña' '>>John Tapias' 'Procesamiento Digital de imagenes' 'Octubre 2016'},'Acerca de','custom',alienIco);
...
msgbox({'a-----Largo máximo del esqueje en centímetros, (Esqueje largo)' 'b-----Largo mínimo en centímetros, (Esqueje corto)' 'c-----Distancia de la base del tallo a la primera hoja ( Esqueje hoja en base) en milímetros.'},'Ayuda','help');
